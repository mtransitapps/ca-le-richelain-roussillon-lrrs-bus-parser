package org.mtransit.parser.ca_le_richelain_roussillon_lrrs_bus;
...
public class LeRichelainRoussillonLRRSBusAgencyTools extends DefaultAgencyTools {

	public static void main(@NotNull String[] args) {
		new LeRichelainRoussillonLRRSBusAgencyTools().start(args);
	}
